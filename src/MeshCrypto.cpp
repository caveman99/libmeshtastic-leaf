...
void MeshCrypto::setKey(const CryptoKey& key) {
    key_ = key;
}
...
void MeshCrypto::encrypt(NodeNum fromNode, uint64_t packetId, uint8_t* bytes, size_t numBytes) {
...
void MeshCrypto::decrypt(NodeNum fromNode, uint64_t packetId, uint8_t* bytes, size_t numBytes) {
