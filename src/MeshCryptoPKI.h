...
public:
     ...
     */
    static bool regeneratePublicKey(uint8_t pubKey[32], const uint8_t privKey[32]);
     ...
     */
    bool encrypt(NodeNum toNode, NodeNum fromNode,
...
private:
     ...
     */
    static void initNonce(NodeNum fromNode, uint64_t packetId, uint32_t extraNonce, uint8_t nonce[13]);
