...
// Rolling airtime accounting. Two windows, because they answer two questions:
// an hour of our own transmissions for duty cycle, and a minute of everything
// heard for contention window sizing.
class MeshAirtime {
public:
