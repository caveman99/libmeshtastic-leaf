...
public:
     ...
     */
    void encrypt(NodeNum fromNode, uint64_t packetId, uint8_t* bytes, size_t numBytes);
     ...
     */
    void decrypt(NodeNum fromNode, uint64_t packetId, uint8_t* bytes, size_t numBytes);
