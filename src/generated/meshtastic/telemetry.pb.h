...
Belongs to Air Quality but is not particle but VOC measurement. Other VOC values
...
relaying). If this number is high, there are nodes in the mesh relaying packets
when it's unnecessary, for example due to the ROUTER/REPEATER role. */
...
did it before us. This will always be zero for ROUTERs/REPEATERs. If this number
is high, some other node(s) is/are relaying faster than you. */
...
#define _meshtastic_TelemetrySensorType_MAX                                    \
  meshtastic_TelemetrySensorType_BH1750
#define _meshtastic_TelemetrySensorType_ARRAYSIZE                              \
  ((meshtastic_TelemetrySensorType)(meshtastic_TelemetrySensorType_BH1750 + 1))
...
#define meshtastic_Telemetry_FIELDLIST(X, a)                                   \
  ...
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (variant, power_metrics, variant.power_metrics), 5)                        \
  X(a, STATIC, ONEOF, MESSAGE, (variant, local_stats, variant.local_stats), 6) \
  X(a, STATIC, ONEOF, MESSAGE,                                                 \
    (variant, health_metrics, variant.health_metrics), 7)                      \
...
#define meshtastic_Telemetry_variant_air_quality_metrics_MSGTYPE               \
  meshtastic_AirQualityMetrics
#define meshtastic_Telemetry_variant_power_metrics_MSGTYPE                     \
  meshtastic_PowerMetrics
#define meshtastic_Telemetry_variant_local_stats_MSGTYPE meshtastic_LocalStats
#define meshtastic_Telemetry_variant_health_metrics_MSGTYPE                    \
  meshtastic_HealthMetrics
