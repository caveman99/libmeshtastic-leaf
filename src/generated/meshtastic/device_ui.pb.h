...
typedef struct _meshtastic_DeviceUIConfig {
  /* A version integer used to invalidate saved files when we make incompatible
   * changes. */
  uint32_t version;
...
#define _meshtastic_CompassMode_ARRAYSIZE                                      \
  ((meshtastic_CompassMode)(meshtastic_CompassMode_FREEZE_HEADING + 1))

#define _meshtastic_Theme_MIN meshtastic_Theme_DARK
#define _meshtastic_Theme_MAX meshtastic_Theme_RED
#define _meshtastic_Theme_ARRAYSIZE                                            \
  ((meshtastic_Theme)(meshtastic_Theme_RED + 1))
...
#define _meshtastic_Language_ARRAYSIZE                                         \
  ((meshtastic_Language)(meshtastic_Language_TRADITIONAL_CHINESE + 1))

#define _meshtastic_DeviceUIConfig_GpsCoordinateFormat_MIN                     \
  meshtastic_DeviceUIConfig_GpsCoordinateFormat_DEC
#define _meshtastic_DeviceUIConfig_GpsCoordinateFormat_MAX                     \
  meshtastic_DeviceUIConfig_GpsCoordinateFormat_MLS
#define _meshtastic_DeviceUIConfig_GpsCoordinateFormat_ARRAYSIZE                                       \
  ((meshtastic_DeviceUIConfig_GpsCoordinateFormat)(meshtastic_DeviceUIConfig_GpsCoordinateFormat_MLS + \
                                                   1))
...
#define meshtastic_DeviceUIConfig_gps_format_ENUMTYPE                          \
  meshtastic_DeviceUIConfig_GpsCoordinateFormat

/* Initializer values for message structs */
#define meshtastic_DeviceUIConfig_init_default                                 \
  {                                                                            \
    0, 0, 0, 0, 0, 0, _meshtastic_Theme_MIN, 0, 0, 0,                          \
        _meshtastic_Language_MIN, false, meshtastic_NodeFilter_init_default,   \
        false, meshtastic_NodeHighlight_init_default, {0, {0}}, false,         \
        meshtastic_Map_init_default, _meshtastic_CompassMode_MIN, 0, 0,        \
        _meshtastic_DeviceUIConfig_GpsCoordinateFormat_MIN                     \
  }
...
#define meshtastic_DeviceUIConfig_init_zero                                    \
  {                                                                            \
    0, 0, 0, 0, 0, 0, _meshtastic_Theme_MIN, 0, 0, 0,                          \
        _meshtastic_Language_MIN, false, meshtastic_NodeFilter_init_zero,      \
        false, meshtastic_NodeHighlight_init_zero, {0, {0}}, false,            \
        meshtastic_Map_init_zero, _meshtastic_CompassMode_MIN, 0, 0,           \
        _meshtastic_DeviceUIConfig_GpsCoordinateFormat_MIN                     \
  }
...
#define meshtastic_DeviceUIConfig_node_highlight_MSGTYPE                       \
  meshtastic_NodeHighlight
...
#define MESHTASTIC_MESHTASTIC_DEVICE_UI_PB_H_MAX_SIZE                          \
  meshtastic_DeviceUIConfig_size
