...
// Sender and id of packets heard recently, so a flooded packet is delivered
// once however many neighbours rebroadcast it. Fixed capacity, reusing the
// oldest slot, which is the discipline the firmware uses: the window is how
// many packets fit, not how old they are.
